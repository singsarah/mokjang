...
import { MeetingScheduleSettings } from "@/components/meeting-schedule-settings";
  ...
  return (
    <main className="min-h-screen bg-card pb-36">
      <div className="mx-auto max-w-md px-6 py-8">
        ...
        <h1 className="mt-2 font-display text-2xl font-bold text-ink">조직 관리</h1>

        <section className="mt-6 rounded-card border border-border/60 bg-white p-6 shadow-sm">
          <div className="text-sm text-ink-muted">조직 이름</div>
